...
INSERT INTO "new_Service" ("autoDeploy", "branch", "createdAt", "domain", "id", "name", "repoAuth", "repoProvider", "repoUrl", "status", "updatedAt") SELECT "autoDeploy", "branch", "createdAt", "domain", "id", "name", "repoAuth", "repoProvider", "repoUrl", "status", "updatedAt" FROM "Service";
DROP TABLE "Service";
